...
export const ContinueWatchingCard: React.FC<ContinueWatchingCardProps> = ({ item }) => {
  ...
  return (
    <div
      ...
      className="group relative flex-shrink-0 w-72 sm:w-80 rounded-2xl overflow-hidden bg-crafted-surface border border-crafted-border hover:border-crafted-brand-rust transition-all duration-300 hover:-translate-y-1 shadow-crafted-card cursor-pointer"
    >
      {/* 16:9 Thumbnail Container */}
      <div className="relative aspect-video w-full overflow-hidden bg-crafted-panel">
        {!imgFailed ? (
          <img
            src={thumbUrl}
            alt=""
      ...
      {/* Info Bottom Bar */}
      <div className="p-3 bg-crafted-surface space-y-1">
